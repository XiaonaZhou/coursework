...
p <- power.prop.test(p1 = 40000/100000, p2 = 40001/100000, sig.level = 0.1, power = 0.80)
p
```
...
We need at least `r p$n` partipants in each group to distinguish such small difference. It's costy and nearly impossible to do this experiment. There are many other things that may increase the likelyhood of getting cancer. Therefore, we can only run a observational experiments, which can not be used to conclude causal relationship between cancer and coffee. 