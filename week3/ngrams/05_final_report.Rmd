...
Most of the terms have half life of 10 years. The term that were forgotten particularly slow is 1900, and the terms that were forgotten particularly quick is 1877,1878,1942. I think that people remebered 1900 longer than other term is because of all the important events happened that year. We can see that by comparing [Wiki page for 1900](https://en.wikipedia.org/wiki/1900) to [Wiki page for 1877](https://en.wikipedia.org/wiki/1877). I considerd points that are far way from half life od ten year as an outlier.
